...
public class Main extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    SpesaModel m = new SpesaModel();
    VuotoModel v = new VuotoModel();
    new AdderPresenter(input,m, v);
    new BuyerPresenter(command[0],m, v);
    new BuyerPresenter(command[1],m, v);
    new DisplayPresenter(display,m);
    new Display2Presenter(display2,v, m);
